...
public interface EmployeeService {
    ...
    /**
     * 退職者（delete_flg = 1）を全件取得します。
     * @return 退職者リスト
     */
    List<Employee> findRetirees();

    /**
     * 社員番号を指定して物理削除します（退職者管理用）。
     * @param empNo 社員番号
     */
    void physicalDeleteById(Integer empNo);

    /**
     * 社員の在籍ステータスを復元（delete_flg = 0）します。
     * @param empNo 社員番号
     */
    void restoreById(Integer empNo);
